...
Purpose-built agent skills (`/aitask-pick` in Claude Code, `$aitask-pick` in Codex CLI) that guide implementation workflows. Additional agent wrappers (Gemini CLI / OpenCode) can be installed when available.
{{% /blocks/feature %}}

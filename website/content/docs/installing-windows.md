...
After setup completes, see [Authentication with Your Git Remote](https://github.com/beyondeye/aitasks#authentication-with-your-git-remote) to configure GitHub access for task locking, sync, and issue integration.

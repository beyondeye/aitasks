...
- [Shadow Agent](shadow-agent/) — Launch an advisory companion agent that reads a running agent's output, helps with prompts and plans, diagnoses failures, and spawns skill-learning sessions.

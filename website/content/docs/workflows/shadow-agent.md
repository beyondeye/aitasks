...
In the picker, **r** marks the focused concern **rejected** (`✗`) rather than forwarding it. The two dispositions are mutually exclusive per row — **Space** forwards, **r** rejects, and pressing the same key again clears the mark.

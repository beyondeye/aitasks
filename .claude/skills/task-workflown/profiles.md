...
Reference documentation for execution profiles used by the task-workflown skill
and calling skills (aitask-pickn, aitask-explore, etc.).
...
```
/aitask-pickn --profile fast
/aitask-pickn 42 --profile fast

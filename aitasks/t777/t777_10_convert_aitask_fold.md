...
- `.claude/skills/aitask-fold/SKILL.md` (replace) — stub
- `.agents/skills/aitask-fold/SKILL.md` (replace) — stub
- `.gemini/skills/aitask-fold/SKILL.md` (replace) — stub
- `.opencode/skills/aitask-fold/SKILL.md` (replace) — stub

...
- `.claude/skills/aitask-pr-import/SKILL.md` (replace) — stub
- `.agents/skills/aitask-pr-import/SKILL.md` (replace) — stub
- `.gemini/skills/aitask-pr-import/SKILL.md` (replace) — stub
- `.opencode/skills/aitask-pr-import/SKILL.md` (replace) — stub

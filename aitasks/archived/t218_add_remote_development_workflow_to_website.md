...
Premise out of date: Claude Code Web uses `/aitask-pickweb`, documented by t227_6 (e27253f60) in `workflows/claude-web.md`; pickrem itself is covered by `skills/aitask-pickrem.md`. Not tracked anywhere after this closure: a workflow page for unattended, non-Web pickrem use, and the testing emphasis (only in the skill today).

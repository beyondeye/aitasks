...
issue_type: feature
status: Ready
labels: [statistics, claudeskills]
...
This is only a sample. extrapolate from it the actual instruction to put in the skill definition. add also instructions in the skill to try to find interesting trends the stats data

...
- [defer] [t832_1] Manual: from `aitasks_mobile`, `./.aitask-scripts/aitask_query_files.sh task-file --project aitasks 832` returns the t832 path in aitasks. — DEFER 2026-05-31 16:57 auto: blocked: sibling aitasks_mobile query_files.sh predates --project; re-exec proven by item 5; re-run after mobile upgrade
...
- [defer] [t832_2] Manual: from `aitasks`, — DEFER 2026-05-31 16:57 auto: manual step truncated/underspecified; functional coverage via item 11 (explain_context test); needs interactive disposition
...
- [defer] [t832_4] Manual: `./.aitask-scripts/aitask_ls.sh -v 5` against a real cross-repo — DEFER 2026-05-31 16:57 auto: live-board 'flags blocked tasks' needs cross-repo blocked task; logic covered by item 17; interactive confirm
...
- [defer] [t832_7] Manual: from `aitasks`, — DEFER 2026-05-31 16:57 auto: manual smoke mutates sibling repo (adds label); skipped per no-mutation policy; interactive
...
- [defer] [t832_8] Stale-registry case: edit `~/.config/aitasks/projects.yaml` to point — DEFER 2026-05-31 16:57 auto: mutates real ~/.config/aitasks/projects.yaml (stale-registry board case); interactive
- [defer] [t832_8] Restore registry. — DEFER 2026-05-31 16:57 auto: paired with item 33 (restore registry); interactive

...
from topic_semantics import (  # noqa: E402
    _bare_topic_id, _task_id_sort_key, parse_task_filename, task_anchor_id,
    task_own_id, topic_key,
)
...
# The board's RENDERING half (RFC §9 in aidocs/implementation_trail_design.md);
# discovery/dedup/overlap/blob-loading live in lib/trail_discovery.py and are
# re-exported at the top of this file (t1647_1). The board renders trail
# projections READ-ONLY: it only ever spawns the read verbs (trail_gather drift,

...
- End-to-end walkthrough:
  - Creating an agentcrew (`ait crew init`)
  - Defining agent types with max_parallel
  - Adding agents with dependencies (`ait crew addtask`)
...
`website/content/docs/commands/crew.md`:
...
`website/content/docs/tuis/crew-dashboard/_index.md`:
- Overview: what the dashboard shows, how to launch

`website/content/docs/tuis/crew-dashboard/how-to.md`:
- How to: spawn agentcrew, start/stop runner, monitor agents

`website/content/docs/tuis/crew-dashboard/reference.md`:
- Keybindings, screens, configuration options

## Step 4: Update TUI index

Add agentcrew dashboard entry to `website/content/docs/tuis/_index.md`.

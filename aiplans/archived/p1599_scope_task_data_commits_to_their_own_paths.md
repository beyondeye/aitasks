...
- The 0%-foreign-rate verification is a lagging indicator: it only becomes meaningful after enough new claims accumulate on the data branch. · severity: low · → mitigation: verify_zero_foreign_rate_after_soak (t1604)

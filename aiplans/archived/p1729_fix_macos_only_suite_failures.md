...
- **Manual-verification failure:** item "The fixture ladder: confirm `tests/lib/fake_agent_binary.py` takes rung 1 on Linux (copies the system `sleep`, which carries no restricted flag), never the compiled or symlink rungs." failed; follow-up task t1744.

...
- Worktree isolation — the one signal that could prove ownership structurally — is **not** used, because freshness cannot be proven after the fact. · severity: low · → mitigation: t1534

...
**Profile-driven plan preference** (profile 'remote').


The effective plan preference is `use_current`. Act on it as follows:
...
- **Complexity Assessment:**
  ...
  - **If creating child tasks:**
    ...
    - **Write implementation plans for ALL child tasks** before proceeding:
      ...
      **outcome contract** in `.agents/skills/ait-git-remote-codex-/SKILL.md`: a
...
Profile 'remote' configures the post-plan action.

The effective action is `post_plan_action: start_implementation`.

...
**Record implementing agent:** Execute the **Agent Attribution Procedure** (see `.agents/skills/task-workflow-remote-/agent-attribution.md`) to record which code agent and model is implementing this task.

...
ROWS=(
    ...
    "task-workflow|manual-verification-followup.md|default|mvf.md:34|manual_verification_followup_mode|If the active profile has \`manual_verification_followup_mode\` set to \`\"never\"\`|Profile 'fast' sets \`manual_verification_followup_mode: ask\`"
)

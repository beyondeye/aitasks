...
**Record implementing agent:** Execute the **Agent Attribution Procedure** (see `.claude/skills/task-workflow/agent-attribution.md`) to record which code agent and model is implementing this task.

...
- If the effective value is `"create_new"`: **Clear the deferred-plan marker first** (see "Clearing on replan" in §6.0-marker above), then proceed with step 6.1 as normal. Display: "Profile 'fast': creating plan from scratch".

...
#   - 12 golden files under tests/golden/skills/aitask-explore/ (3 profiles × 4 agents)
# Coverage:
...
assert_contains "codex/fast: task-workflow ref rewritten under .agents/skills" \
    ".agents/skills/task-workflow-fast-/SKILL.md" "$(cat .agents/skills/aitask-explore-fast-/SKILL.md)"
assert_contains "gemini/fast: task-workflow ref rewritten under .gemini/skills" \
    ".gemini/skills/task-workflow-fast-/SKILL.md" "$(cat .gemini/skills/aitask-explore-fast-/SKILL.md)"
...
GEMINI_STUB=".gemini/commands/aitask-explore.toml"
...
assert_contains "codex stub: reads from .agents/skills/aitask-explore-<profile>-" \
    ".agents/skills/aitask-explore-<profile>-/SKILL.md" "$(cat "$CODEX_STUB")"
assert_contains "gemini stub: reads from .gemini/skills/aitask-explore-<profile>-" \
    ".gemini/skills/aitask-explore-<profile>-/SKILL.md" "$(cat "$GEMINI_STUB")"

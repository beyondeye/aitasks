...
**Record implementing agent:** Execute the **Agent Attribution Procedure** (see `.gemini/skills/task-workflow-remote-/agent-attribution.md`) to record which code agent and model is implementing this task.
...
4. **Commit code changes and plan file separately:**
   - **Code commit:**
     ...
     # Code-Agent Commit Attribution Procedure from .gemini/skills/task-workflow-remote-/code-agent-commit-attribution.md,

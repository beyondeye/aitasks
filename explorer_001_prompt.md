...
- `_work2do.md` → .aitask-crews/crew-brainstorm-427/explorer_001_work2do.md
- `_input.md` → .aitask-crews/crew-brainstorm-427/explorer_001_input.md
- `_output.md` → .aitask-crews/crew-brainstorm-427/explorer_001_output.md
- `_instructions.md` → .aitask-crews/crew-brainstorm-427/explorer_001_instructions.md
- `_status.yaml` → .aitask-crews/crew-brainstorm-427/explorer_001_status.yaml
- `_commands.yaml` → .aitask-crews/crew-brainstorm-427/explorer_001_commands.yaml
- `_alive.yaml` → .aitask-crews/crew-brainstorm-427/explorer_001_alive.yaml
